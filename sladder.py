...
dir_path = Path('sladder_output/sladder/')

train_data_path = "data/cladder/cladder_sol/cladder-v1-questions.json"
dev_file_paths = [
...
# ]
graph_rep_model_path = "pretrained_models/graph_rep_model_sladder.pt"
nclass = 2
max_length = 4
beam_size = 5
...
for path in dev_file_paths:
    ...
    dev_centers_list[path] = cal_nwgm_center_attention(graph_rep_model_path, dev_dataloader, nclass, device,
...
train_centers = cal_nwgm_center_attention(graph_rep_model_path, train_tqdm_iterator, nclass, device, feature_num,
