...
# from models import ONE_ATTENTION_with_LLM
...
# def cal_nwgm_center_LLM(model_path, dataloader, nclass, device, feature_num, evi_num):
#     model = ONE_ATTENTION_with_LLM(feature_num, nclass, evi_num)
#     model = model.to(device)
#     model_path = "/home/disk2/ghh/llama"
...
# def cal_nwgm_center_attention_LLM(model_path, dataloader, nclass, device, feature_num, evi_num, n_cluster, politihop_2way=False):
#     print(feature_num)
#     if politihop_2way: # now nclass == 2 but the graph rep model need nclass == 3
#         model = ONE_ATTENTION_with_LLM(feature_num, 3, evi_num)
